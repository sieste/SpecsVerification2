...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlfunctioncall{Auc}(\hlfunctioncall{rowMeans}(ens.bin), obs.bin)
\end{alltt}
\begin{verbatim}
##     auc  auc.sd 
## 0.89489 0.06561
...
\definecolor{shadecolor}{rgb}{0.933, 0.933, 0.933}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlfunctioncall{AucDiff}(\hlfunctioncall{rowMeans}(ens.bin), \hlfunctioncall{rowMeans}(ens.bin)+\hlfunctioncall{rnorm}(\hlfunctioncall{nrow}(ens.bin)), obs.bin)
\end{alltt}
\begin{verbatim}
...
## 2 0.5833     0.4286  0.1825  1.0000        7    0.3333    0.6667
