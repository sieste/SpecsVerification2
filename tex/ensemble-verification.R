...
## @knitr label=gfs-plot, fig.width=4, fig.height=2
...
## @knitr label=rank-hist-pp, fig.width=5, fig.height=3.5
...
## @knitr label=reldiag, fig.width=4, fig.height=4.5
