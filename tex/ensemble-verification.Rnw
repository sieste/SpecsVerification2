...
\Plaintitle{Forecast Verification Functions Implemented in the R Package SpecsVerification: Ensemble-adjusted scores, comparative verification, and uncertainty quantification}
...
\textit{This section is not part of the paper}
