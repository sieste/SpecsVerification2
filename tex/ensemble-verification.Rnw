...
\Plaintitle{Forecast Verification: Ensemble-adjusted scoring rules, graphical tools, comparative verification, and uncertainty assessment implemented in the R package SpecsVerification}
...
\Keywords{ensemble forecasting, forecast verification, finite-ensemble effect, comparative verification, uncertainty, \proglang{R}}
\Plainkeywords{ensemble forecasting, forecast verification, finite-ensemble effect, comparative verification, uncertainty, R} %% without formatting
