...
<<>>=
CorrDiff(ens.mean, obs.lag, obs)
@


\subsection{Area under the ROC curve (AUC) and AUC differences}

<<>>=
AucDiff(rowMeans(ens.bin), 0 * obs.bin, obs.bin)
@


\citet{mason2002areas}

\citet{delong1988comparing}
